...
export function SolarSystem(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("./planet/solar_system.glb");
  const { actions, names } = useAnimations(animations, group);

  useLayoutEffect(() => {
    // Vérifie les animations disponibles
    console.log("🎬 Animations disponibles :", names);

    // Active l’animation “Animation” (ou la première si le nom diffère)
...
useGLTF.preload('./planet/solar_system.glb')
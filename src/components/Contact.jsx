      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10">
        ...
        >
          <div className="relative bg-gradient-to-br from-[#1e1b4b]/40 to-[#0f0d2e]/40 rounded-3xl overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-500 backdrop-blur-sm">
            ...
            <div className="absolute -bottom-12 -right-12 w-48 h-48 bg-gradient-to-br from-cyan-400 to-blue-600 opacity-20 blur-3xl rounded-full group-hover:scale-150 transition-transform duration-700" />
        ...
        >
          <div className="relative h-full bg-gradient-to-br from-[#1e1b4b]/40 to-[#0f0d2e]/40 rounded-3xl overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-500 backdrop-blur-sm">
            ...
            <div className="absolute -top-12 -left-12 w-48 h-48 bg-gradient-to-br from-purple-400 to-pink-600 opacity-20 blur-3xl rounded-full group-hover:scale-150 transition-transform duration-700" />
            <div className="absolute -bottom-12 -right-12 w-48 h-48 bg-gradient-to-br from-cyan-400 to-blue-600 opacity-20 blur-3xl rounded-full group-hover:scale-150 transition-transform duration-700" />

            {/* 3D Model Container - Vous pouvez ajouter votre modèle 3D ici */}
            <div className="relative h-full flex items-center justify-center p-8">
              ...
              <div className="text-center">
                ...
                <p className="text-white/70 text-lg Microgram">
                  Votre modèle 3D ici
                </p>

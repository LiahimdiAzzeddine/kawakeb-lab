...
import { SocialMediaButton } from "./components/sub-components";
...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center ms:max-w-[90%] max-w-full custom-max-w mx-auto relative z-50">
...
function App() {
  return (
    <BrowserRouter>
      ...
      <div className="">
        {/* Canvas plein écran en fond ne la touche pas svp garder la */}
        <BackgroundCanvas />
